  ...
  return (
    <div className="space-y-6 bg-card rounded-xl p-6 shadow-lg">
      ...
      <div className="flex items-center gap-2 mb-6">
            ...
            <div className="max-h-48 overflow-y-auto">
              ...
              {userPresets.map((preset, index) => (
                ...
                >
                  ...
                  >
                    <svg xmlns="https://github.com/dolev765/wasd/blob/main/picture-1200.png?raw=true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
                      <path d="M3 6h18" />
        ...
        >
          <svg xmlns="https://github.com/dolev765/wasd/blob/main/picture-1200.png?raw=true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
